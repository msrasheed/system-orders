...
let ApproveFormComponent = class ApproveFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
...
let BaseFormComponent = class BaseFormComponent {
    ...
    submitForm(append) {
        ...
        // }
        this.orderhttp.submitForm(formData).then(res => {
            this.orderhttp.refreshOrderList().then(res => {
...
HardwareDisplay.ctorParameters = () => [
    { type: String },
    { type: String }
];
let CreateFormComponent = class CreateFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
        this.removeSoftNums = "";
        ...
        this.hardwares = [];
        let dummyHard = new _order__WEBPACK_IMPORTED_MODULE_3__["HardwareItems"]();
...
let DeleteFormComponent = class DeleteFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
...
let DeliveredFormComponent = class DeliveredFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
...
NewButtonComponent.ctorParameters = () => [
...
let NewOrderComponent = class NewOrderComponent extends _create_form_create_form_component__WEBPACK_IMPORTED_MODULE_2__["CreateFormComponent"] {
    constructor() {
        super();
...
class OrderBrief {
    constructor(orderid, userid, status, dateNeeded, clientContact, supportApproval, gmApproval, finalid, arrived) {
...
class FormPerms {
    constructor(view, edit, reqs) {
        this.view = view;
        this.edit = edit;
        this.reqs = reqs;
    }
}
FormPerms.ctorParameters = () => [
    { type: Boolean },
    { type: Boolean },
    { type: Boolean }
];
let OrderViewComponent = class OrderViewComponent {
    constructor(router, activeRoute, orderhttp, currUser, datepipe) {
        this.router = router;
    ...
    ngOnInit() {
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])((event) => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed)).subscribe(() => {
    ...
    loadOrder() {
        ...
        this.orderhttp.getOrder(this.orderid)
            ...
            if (this.order.quotedDate)
                this.order.quotedDate = this.convertDateFormat(this.order.quotedDate);
            if (this.order.dateArrived)
                this.order.dateArrived = this.convertDateFormat(this.order.dateArrived);
...
class SoftwareItem {
    constructor(softid, software) {
        this.softid = softid;
        this.software = software;
    }
}
SoftwareItem.ctorParameters = () => [
    { type: String },
    { type: String }
];
class OtherItem {
    constructor(otherid, otherspec) {
        this.otherid = otherid;
        this.otherspec = otherspec;
    }
}
OtherItem.ctorParameters = () => [
    { type: String },
    { type: String }
];
class HardwareItems {
...
let OrdersModuleViewComponent = class OrdersModuleViewComponent {
...
OrdersModuleViewComponent.ctorParameters = () => [
...
let OrdersRestfulService = class OrdersRestfulService {
    constructor(http, configRest) {
        this.http = http;
    ...
    getOrder(id) {
        let apiURl = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + 'app/orders?orderid=' + id;
        return this.http.get(apiURl).toPromise();
    }
    downloadFile(orderid, filename) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + `app/orders?orderid=${orderid}&file=${filename}`;
    ...
    submitForm(form) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + `app/orders`;
    ...
    dummySubmitForm(form) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + `app/cunt`;
        console.log('posting: ', form);
...
OrdersRestfulService.ctorParameters = () => [
...
let OrdersTrayListItemComponent = class OrdersTrayListItemComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let OrdersTrayListComponent = class OrdersTrayListComponent {
    constructor(orderhttp) {
        this.orderhttp = orderhttp;
    }
    ngOnInit() {
    }
};
OrdersTrayListComponent.ctorParameters = () => [
...
let OrdersTraySearchComponent = class OrdersTraySearchComponent {
    constructor(orderhttp) {
        this.orderhttp = orderhttp;
    }
    ngOnInit() {
        this.searchField = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]();
        this.searchField.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])()).subscribe(value => this.orderhttp.orderQuery = value);
    }
};
OrdersTraySearchComponent.ctorParameters = () => [
...
let OrdersTrayComponent = class OrdersTrayComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let OrdersViewModule = class OrdersViewModule {
};
...
let PurchaseFormComponent = class PurchaseFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
...
let QuoteFormComponent = class QuoteFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
...
class Status {
    constructor(acronym, color) {
        this.acronym = acronym;
        this.color = color;
    }
}
Status.ctorParameters = () => [
    { type: String },
    { type: String }
];
let StatusTransformPipe = class StatusTransformPipe {
    constructor() {
        this.statDict = {
...
let VerifyFormComponent = class VerifyFormComponent extends _base_form_base_form_component__WEBPACK_IMPORTED_MODULE_2__["BaseFormComponent"] {
    constructor() {
        super();
    }
    ngOnInit() {
