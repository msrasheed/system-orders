...
let InboxButtComponent = class InboxButtComponent {
    constructor() { }
    ngOnInit() {
        this.deactivate();
    }
...
let InboxButtonsComponent = class InboxButtonsComponent {
    constructor(restConfig, router) {
        this.restConfig = restConfig;
        this.router = router;
...
InboxButtonsComponent.ctorParameters = () => [
    { type: _restful_config_service__WEBPACK_IMPORTED_MODULE_3__["RestfulConfigService"] },
...
class Button {
    constructor(title, icon, urlQ, visibleTo) {
        this.title = title;
        this.icon = icon;
        this.urlQ = urlQ;
...
let RestfulConfigService = class RestfulConfigService {
    constructor() {
        this.butts = [
    ...
    setOrdersRestfulService(service) {
        this.ordersRestService = service;
    }
    getButtonWithTitle(title) {
        for (let butt of this.butts) {
            if (butt.title == title)
                return butt;
        }
