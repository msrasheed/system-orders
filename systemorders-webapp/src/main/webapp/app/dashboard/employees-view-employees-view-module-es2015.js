...
let EmployeeTrayItemComponent = class EmployeeTrayItemComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
EmployeeTrayItemComponent.ctorParameters = () => [
...
class Employee {
    constructor(userid, fname, lname, username, role, email) {
        this.userid = userid;
        this.fname = fname;
        this.lname = lname;
...
let EmployeesModuleViewComponent = class EmployeesModuleViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let EmployeesRESTfulService = class EmployeesRESTfulService {
    constructor(http) {
        this.http = http;
        this.refreshEmployeeList();
    }
    refreshEmployeeList() {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + 'app/users?allusers';
    ...
    createEmployee(emp) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + 'app/users?operation=create';
    ...
    updateEmployee(emp) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + 'app/users?operation=update';
        let formData = new FormData();
        for (var key in emp) {
            formData.append(key, emp[key]);
        }
    ...
    deleteEmployee(empid) {
        let apiURL = _config__WEBPACK_IMPORTED_MODULE_3__["Config"].baseURL + 'app/users?operation=delete';
        let formData = new FormData();
...
EmployeesRESTfulService.ctorParameters = () => [
...
let EmployeesViewModule = class EmployeesViewModule {
};
...
let UsersTrayComponent = class UsersTrayComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=employees-view-employees-view-module-es2015.js.map